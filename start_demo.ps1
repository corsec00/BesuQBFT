...
## Cria a rede rede_besu com o IP definido para cada nó de acordo com o besu:lfdt. Quando terminar, o container eh removido (--rm) e o container eh iniciado em modo interativo (-it) com o bash (/bin/bash). 
